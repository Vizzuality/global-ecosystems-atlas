...
export const EFGSExtent = () => {
  return (
    <div className="space-y-4 pt-4">
      <div className="h-4">
        <ParentSize>
          {({ width, height }) => <EFGSExtentChart width={width} height={height} />}
        </ParentSize>
      </div>
...
export const EFGSExtentChart = ({ width, height }: { width: number; height: number }) => {
...
export const EFGSExtentRanking = () => {
  const [location] = useSyncLocation();
