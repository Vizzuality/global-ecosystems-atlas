...
export interface RasterMaskedExtensionLayerProps extends LayerProps, TileLayerProps {
  id: string;
...
class RasterMaskedExtensionLayer {
  constructor({
    id,
    source,
    visibility,
    ...
    bitmapProps,
    ...props
  }: RasterMaskedExtensionLayerProps) {
...
export default RasterMaskedExtensionLayer;
